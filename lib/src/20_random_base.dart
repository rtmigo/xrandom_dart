...
abstract class RandomBase32 implements Random {
  ...
  int nextInt(int max) {
    ...
    if (max < 1) {
      ...
      // IN UINT53 RANGE ///////////////////////////////////////////////////////
      // at least it fits into 53 bits. We can process it in JS

      // https://en.wikipedia.org/wiki/Xoroshiro128%2B
      //    "The lowest bits of the output generated by xoroshiro128+ have
      //    low quality."
      // https://en.wikipedia.org/wiki/Xorshift
      //    "The scramblers known as + and * still leave weakness in
      //    the low bits"
      ...
      if (!INT64_SUPPORTED) {
        // it's kinda weird: we are running JS, but got a value higher than
        // JS_MAX_SAFE_INTEGER. Is this a lost double? However, the question
        // is not where it came from. We could even calculate the return value,
        // but we won't be able to return the result as an int
